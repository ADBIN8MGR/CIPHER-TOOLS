...
![Example 1: Encoding "hello" with a shift of 3]<div style="text-align: center;"> <img src="example1-image.png" alt="Example 1: Encoding 'hello' with a shift of 3" width="400"/> <p style="text-align: center;"><em>Example 1: Encoding 'hello' with a shift of 3</em></p> </div>
